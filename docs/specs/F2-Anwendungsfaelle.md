...
| Akteur | Nutzer |
| Ziel | Beim Eingeben des Namens automatisch eine neue, eindeutige UserID erzeugen, damit der Nutzer ohne klassisches Login eindeutig identifizierbar ist und Favoriten, Besuche und Bewertungen später zugeordnet werden können. |
...
| Hauptszenario |1. Der Nutzer öffnet die Einstiegsmaske.<br>2. Der Nutzer gibt seinen Namen ein.<br>3. Food-Mood erzeugt automatisch eine neue, eindeutige UserID.<br>4. Die UserID wird angezeigt und lokal gespeichert.<br>5. Der Nutzer gelangt zur Startseite. |
| Alternativen | Der Nutzer gibt stattdessen eine bestehende UserID ein (siehe UC-01). |
| Fehlerfälle |  Der Name wird nicht eingegeben ("Bitte einen Namen eingeben"). Die UserID kann nicht erzeugt oder gespeichert werden.|
| Ergebnis | Eine neue UserID wurde automatisch erzeugt und dem Nutzer zugeordnet.|
| Datenmodell | Link D1/D2 |
| Dialog | [M-00 Einstieg](B1-Dialogspezifikation.md#m-00--einstieg) |
...
| Vorbedingungen |  Der Nutzer wählt aufer besitzt bereits eine gültige UserID. |
| Auslöser | Der Nutzer gibt auf der Einstiegsmaske seine bestehende UserID ein und wählt "Profil laden"|.
| Hauptszenario | 1. Der Nutzer öffnet die Einstiegsmaske.<br>2. Der Nutzer gibt seine bestehende UserID ein.<br>3. Der Nutzer wählt "Profil laden".<br>4. Food-Mood prüft die UserID.<br>5. Das zugehörige Profil wird geladen.<br>6. Der Nutzer gelangt zur Startseite.|
| Alternativen | Der Nutzer gibt stattdessen einen Namen ein, wodurch automatisch eine neue UserID erzeugt wird (siehe UC-00). |
| Fehlerfälle | Die eingegebene UserID ist ungültig oder unbekannt ("UserID nicht gefunden. Bitte prüfen oder neues Profil erstellen"). |
...
| Hauptszenario | 1. Der Nutzer kehrt zur Einstiegsmaske zurück.<br>2. Der Nutzer gibt entweder eine andere UserID ein und wählt "Profil laden", oder gibt einen neuen Namen ein, wodurch automatisch eine neue UserID erzeugt wird.<br>3. Food-Mood wechselt zum entsprechenden Profil. |
| Alternativen | – |
...
| Datenmodell | Link D1/D2 |
| Dialog | [M-02 Standortfreigabe](B1-Dialogspezifikation.md#m-02--standortfreigabe)|
...
| Datenmodell | Link D1/D2 |
| Dialog | [M-03 Stimmung & Anlass](B1-Dialogspezifikation.md#m-03--stimmung--anlass) |
...
| Datenmodell | Link D1/D2 |
| Dialog | [M-04 Filterauswahl](B1-Dialogspezifikation.md#m-04--filterauswahl)|
...
| Datenmodell | Link D1/D2 |
| Dialog | [M-05 Empfehlungsliste](B1-Dialogspezifikation.md#m-05--empfehlungsliste)|
...
| Datenmodell | Link D1/D2 |
| Dialog | [M-06 Restaurantdetails](B1-Dialogspezifikation.md#m-06--restaurantdetails)|
...
+| Datenmodell | Link D1/D2 |
| Dialog | [M-07 Favoriten](B1-Dialogspezifikation.md#m-07--favoriten) |
